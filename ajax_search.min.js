...
(function(win,doc){
  ...
  function extend(a,b){b=b||{};for(var i in a){
    if(!is_set(b[i])){
      b[i]=a[i]
  ...
  win['_'+fn]=function($){
    ...
    list=function(current){
      ...
      if(size){
        ...
        // Gunakan native lazy loading dengan atribut loading="lazy" dan src langsung (tanpa data-src)
        str+=has_image?
          '<img alt="thumbnail" loading="lazy" src="'+
          current.media$thumbnail.url.replace(/\/s\d+(\-c)?\//g,'/'+size+'/')+
